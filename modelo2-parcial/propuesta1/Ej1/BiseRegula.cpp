...
{
  double a = 3.0, b = 4.0, c, error = 1, errorMin = pow(10, -5), anterior, iteraciones = 0;
  ...
  printf("la cantidad de iteraciones fueron:%f\n",iteraciones);
  printf("El error obtenido es de:%f",error);
  return 0;
}

double f(double x)
{
  return -3 + 4.23333*x  - 1.35* x *x + 0.116667 *x *x*x;
}
